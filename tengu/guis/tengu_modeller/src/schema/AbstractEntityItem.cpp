...
// ********************************************************************************************************************
// *                                                                                                                  *
// *                                         Return type of entity if exists.                                         *
// * ---------------------------------------------------------------------------------------------------------------- *
// *                                     Вернуть тип сущности, если она существует.                                   *
// *                                                                                                                  *
// ********************************************************************************************************************

tengu::AbstractEntity::entity_types_t tengu::AbstractEntityItem::entityType() {
    
    if ( _entity ) {
        return _entity->entityType();
    };
    
    return AbstractEntity::ET_Unknown;
}
...
// * ---------------------------------------------------------------------------------------------------------------- *
// *                                           Обновить элемент на экране                                             *
// *                                                                                                                  *
// ********************************************************************************************************************
//
//void tengu::AbstractEntityItem::update ( const QRectF& rect ) {
