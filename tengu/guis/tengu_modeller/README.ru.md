...
- **19 jun 2017** Прекращение создания связи - Escape'ом.
- **18 jun 2017** Элементы ANDor, ORer. Измерение имени задачи. Переделанный метод рисования. Создание связи (не закончено).
